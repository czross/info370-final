...
********** Marisa
The key findings of our research showed that a poisson regression showed no correlation between the GDP per person and crime per person in each metropolitan area with population as another independent variable. Between all of the years from 2010 to 2015, there was no significance between GDP per person, crime per person, and population of a metropolitan area for any compared years. From this, our contribution to society and information in general is that just looking at a metropolitan area's economy and population is not a good determining factor on the number of crimes permitted by person. 
