...
For this research project we decided to use two datasets for our analysis; one for crime based data on U.S. cities over a 5 year time period (2010-2015), and one for the GDP for metropolitan areas in the U.S. over a 5 year time period (2010-2015). 

#### FBI Crime Dataset

You can see a sample of what the crime dataset looks like (shows all 5 years) [Here](../resource/crime-dataset.html).
